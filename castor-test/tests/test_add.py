...
def test_add_without_initialized_store_error(cli, castor_store, sample_file):
    """Test adding to non-initialized store fails."""
    # castor_store is not initialized
    result = cli.add(sample_file, root=castor_store, expect_success=False)
