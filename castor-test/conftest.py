...
@pytest.fixture
def castor_store(tmp_path) -> Path:
    """
...
@pytest.fixture
def initialized_store(castor_store, cli) -> Path:
    """
    Pre-initialized Castor store.

    Args:
        castor_store: Store directory fixture
...
@pytest.fixture
def cli(castor_binary) -> CastorCLI:
    """
    Configured CLI wrapper instance.

    Args:
        castor_binary: Binary path fixture

    Returns:
        CastorCLI instance
    """
    return CastorCLI(castor_binary)
